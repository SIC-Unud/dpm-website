              ...
              <h2 class="accordion-header" id="flush-headingOne">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                  ...
                  <img class="lazyload" src="{{ asset('img/spinner.svg') }}"
                    data-src="{{ asset('img/purpose-icon/icon_01.png') }}" alt="" height="50">
            ...
            <div class="accordion-item" data-aos="fade-up" data-aos-duration="3000">
              <h2 class="accordion-header" id="flush-headingTwo">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                  ...
                  <img class="lazyload" src="{{ asset('img/spinner.svg') }}"
                    data-src="{{ asset('img/purpose-icon/icon_04.png') }}" alt="" height="50">
            ...
            <div class="accordion-item" data-aos="fade-up" data-aos-duration="3000">
              <h2 class="accordion-header" id="flush-headingThree">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                  ...
                  <img class="lazyload" src="{{ asset('img/spinner.svg') }}"
                    data-src="{{ asset('img/purpose-icon/icon_03.png') }}" alt="" height="50">
            ...
            <div class="accordion-item" data-aos="fade-up" data-aos-duration="3000">
              <h2 class="accordion-header" id="flush-headingFour">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                  ...
                  <img class="lazyload" src="{{ asset('img/spinner.svg') }}"
                    data-src="{{ asset('img/purpose-icon/icon_02.png') }}" alt="" height="50">
                    ...
                    @foreach ($orderedUsers[$loop->index] as $user)
                      <div class="col-lg-3 col-md-6 col-sm-12 fungsio-col" data-aos="fade-up" data-aos-delay="200">
                        <div class="card-funsionaris p-0" data-aos="fade-left">
                          <div class="card-image"> <img class="lazyload" src="{{ asset('img/spinner.svg') }}"
                              data-src="{{ $user->image }}" height="700px" alt=""> </div>
        ...
        <div class="carousel-inner">
          @foreach ($documents as $document)
            <div class="carousel-item {{ $loop->first ? 'active' : '' }}">
              <img src="{{ asset('img/spinner.svg') }}" data-src="{{ asset('img/hero-bg.jpg') }}" alt="New York"
                height="600px" class=" img-trasnparant lazyload" style="width:100%">
              <div class="carousel-caption">
                <div class="row">
                  <div class="col img-col"><img src="{{ asset('img/spinner.svg') }}"
                      data-src="{{ $document->image }}" height="300" alt="" class="img-caption lazyload">
                  </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-5 d-flex align-items-stretch">
            <div class="info">
              <img src="{{ asset('img/spinner.svg') }}" data-src="{{ asset('img/aspiration.jpg') }}" class="lazyload"
                frameborder="0" style="border:0; width: 100%; height: 600px;" allowfullscreen>
        ...
        <div class="row justify-content-center align-items-center">
          ...
          <div class="col-lg-6 col-md-6 footer-contact">
            <h3><a class="navbar-brand" href="#"><img src="{{ asset('img/spinner.svg') }}"
                  data-src="{{ asset('img/logo.png') }}" alt="logo DPM UNUD" width="40" height="40"
                  class="lazyload" /><span class="title-text-DPM"> DPM PM UNUD</span></a></h3>
            <p>
